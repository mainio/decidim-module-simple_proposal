    ...
    class Engine < ::Rails::Engine
      ...
      initializer "decidim_proposals.overrides" do |app|
        app.config.to_prepare do
          ...
          Decidim::BaseDiffRenderer.include(Decidim::SimpleProposal::BaseDiffRendererExtensions)
          ...
          Decidim::Proposals::Permissions.include(Decidim::SimpleProposal::PermissionsOverrides)
